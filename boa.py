...
class Error:
    ...
    def string(self):
        ...
        #result += "\n\n" + termcolor.colored(string_with_arrows(self.pos_start.ftxt, self.pos_end), "red", attrs=["bold"])
...
class InvalidSyntaxError(Error):
     def __init__(self, pos_start, pos_end, details):
        super().__init__(pos_start, pos_end, "Invalid Syntax", details) # No clue what this does
...
class Position:
    ...
    def copy(self):
        return Position(self.idx, self.ln, self.col, self.fn, self.ftx)
